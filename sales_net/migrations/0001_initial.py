    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Создатель поставщика')),
                ('product', models.ManyToManyField(to='products.product', verbose_name='Продукт')),
                ('provider', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='sales_net.salesnet', verbose_name='Поставщик')),
            ],
            options={
